...
struct Sector { int16_t floorHeight, ceilingHeight; const Flat *floortexture, *ceilingtexture; uint16_t lightlevel, type, tag; };
...
struct Viewpoint { int16_t x, y, z; float angle, cosa, sina; };
