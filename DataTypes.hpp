...
struct Sector { int16_t floorHeight, ceilingHeight; std::vector<const Flat *> floortexture, ceilingtexture; uint16_t lightlevel, type, tag; const Patch *sky; std::vector<const struct Linedef*> linedefs;};
