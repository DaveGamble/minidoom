...
//		if (!wad.getFlat(floorname)) printf("Didn't find flat [%s]\n", floorname);
//		if (!wad.getFlat(ceilname)) printf("Didn't find flat [%s]\n", ceilname);
...
//		if (!wad.getTexture(uname) && strcmp(uname, "-")) printf("Didn't find texture [%s]\n",uname);
//		if (!wad.getTexture(lname) && strcmp(lname, "-")) printf("Didn't find texture [%s]\n",lname);
//		if (!wad.getTexture(mname) && strcmp(mname, "-")) printf("Didn't find texture [%s]\n",mname);
